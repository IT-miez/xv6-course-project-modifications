...
int main() {
  ...
  char buf[69];
  read(fd, buf, 4);
  13:	8d 75 a3             	lea    -0x5d(%ebp),%esi
int main() {
  16:	51                   	push   %ecx
  17:	83 ec 5c             	sub    $0x5c,%esp
  int count = getreadcount();
  1a:	e8 64 03 00 00       	call   383 <getreadcount>
  printf(1, "Before calling read(): %d\n", count);
  ...
  30:	5a                   	pop    %edx
  31:	6a 00                	push   $0x0
  33:	68 c3 07 00 00       	push   $0x7c3
  38:	e8 e6 02 00 00       	call   323 <open>
  read(fd, buf, 4);
  ...
  44:	56                   	push   %esi
  45:	50                   	push   %eax
  46:	e8 b0 02 00 00       	call   2fb <read>
  printf(1, "read: %s\n", buf);
  4b:	83 c4 0c             	add    $0xc,%esp
  4e:	56                   	push   %esi
  4f:	68 ca 07 00 00       	push   $0x7ca
  54:	6a 01                	push   $0x1
  56:	e8 e5 03 00 00       	call   440 <printf>
  count = getreadcount();
  5b:	e8 23 03 00 00       	call   383 <getreadcount>
  ...
  73:	e8 93 02 00 00       	call   30b <close>
  exit();
  78:	e8 66 02 00 00       	call   2e3 <exit>
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb ee 07 00 00       	mov    $0x7ee,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 a8 0a 00 00       	mov    %eax,0xaa8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 a8 0a 00 00       	mov    0xaa8,%eax
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf ac 0a 00 00       	mov    $0xaac,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 ac 0a 00 00 ac 	movl   $0xaac,0xaac
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 78b:	c7 05 b0 0a 00 00 00 	movl   $0x0,0xab0
 792:	00 00 00 
    if(p->s.size >= nunits){
