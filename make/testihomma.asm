...
_testihomma:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  20:	e8 7b 02 00 00       	call   2a0 <atoi>
  ...
  4a:	5a                   	pop    %edx
  4b:	6a 00                	push   $0x0
  4d:	68 f3 07 00 00       	push   $0x7f3
  52:	e8 fc 02 00 00       	call   353 <open>
  char buf[100];
  read(fd, buf, 99);
  ...
  read(fd, buf, 99);
  5c:	8d 45 84             	lea    -0x7c(%ebp),%eax
  5f:	6a 63                	push   $0x63
  61:	50                   	push   %eax
  62:	53                   	push   %ebx
  63:	e8 c3 02 00 00       	call   32b <read>
  count = getreadcount(0);
  68:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  6f:	e8 3f 03 00 00       	call   3b3 <getreadcount>
  printf(1, "Readcount after calling read(): %d\n", count);
  74:	83 c4 0c             	add    $0xc,%esp
  77:	50                   	push   %eax
  78:	68 24 08 00 00       	push   $0x824
  7d:	6a 01                	push   $0x1
  ...
  87:	e8 af 02 00 00       	call   33b <close>
  exit();
  8c:	e8 82 02 00 00       	call   313 <exit>
    printf(1,"\nCounter has been reset!\n\n");
  91:	51                   	push   %ecx
  92:	51                   	push   %ecx
  93:	68 d8 07 00 00       	push   $0x7d8
  98:	6a 01                	push   $0x1
  9a:	e8 d1 03 00 00       	call   470 <printf>
  9f:	83 c4 10             	add    $0x10,%esp
  a2:	eb 95                	jmp    39 <main+0x39>
  a4:	66 90                	xchg   %ax,%ax
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 50 08 00 00 	movzbl 0x850(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 48 08 00 00       	mov    $0x848,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 645:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 00 0b 00 00       	mov    %eax,0xb00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 00 0b 00 00       	mov    0xb00,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 ...
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 04 0b 00 00       	mov    $0xb04,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
